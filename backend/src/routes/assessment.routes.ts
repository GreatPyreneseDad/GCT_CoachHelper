    ...
    types: [
      {
        ...
        description: 'Comprehensive baseline assessment for new clients',
      ...
      },
      {
        id: 'quick_checkin',
        name: 'Quick Check-in',
        description: 'Brief assessment to track daily coherence',
      ...
      },
      {
        ...
        description: 'In-depth exploration of specific coherence dimensions',
